 ...
 * on 2015-05-06 at 12:04:45 UTC 
 * Modify at your own risk.
 */

package com.appspot.blobstore.helloworld;
...
public class Helloworld extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://blobstore.appspot.com/_ah/api/";
  ...
  public class Greetings {
    ...
    public class GetGreeting extends HelloworldRequest<com.appspot.blobstore.helloworld.model.HelloGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.blobstore.helloworld.model.HelloGreeting.class);
    ...
    /**
     * Create a request for the method "greetings.images".
     *
     * This request holds the parameters needed by the helloworld server.  After setting any optional
     ...
     * @return the request
     */
    public Images images() throws java.io.IOException {
      Images result = new Images();
      initialize(result);
      return result;
    }

    public class Images extends HelloworldRequest<BitmapDrawable> {

      private static final String REST_PATH = "helloimages";
       ...
       */
      protected Images() {
        super(Helloworld.this, "GET", REST_PATH, null, BitmapDrawable.class);
      }
    ...
    public class ListGreeting extends HelloworldRequest<com.appspot.blobstore.helloworld.model.HelloGreetingCollection> {
      ...
      protected ListGreeting() {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.blobstore.helloworld.model.HelloGreetingCollection.class);
      }
     ...
     *
     * @param times
     * @param content the {@link com.appspot.blobstore.helloworld.model.HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.appspot.blobstore.helloworld.model.HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends HelloworldRequest<com.appspot.blobstore.helloworld.model.HelloGreeting> {
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.appspot.blobstore.helloworld.model.HelloGreeting content) {
        super(Helloworld.this, "POST", REST_PATH, content, com.appspot.blobstore.helloworld.model.HelloGreeting.class);
