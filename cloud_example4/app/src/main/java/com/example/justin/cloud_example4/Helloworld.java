...
public class Helloworld extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://example-88523.appspot.com/_ah/api/";
  ...
  public class Greetings {
    ...
    public class GetGreeting extends HelloworldRequest<com.appspot.example_88523.helloworld.model.HelloGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.example_88523.helloworld.model.HelloGreeting.class);
    ...
    public class ListGreeting extends HelloworldRequest<com.appspot.example_88523.helloworld.model.HelloGreetingCollection> {
      ...
      protected ListGreeting() {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.example_88523.helloworld.model.HelloGreetingCollection.class);
      }
     ...
     *
     * @param times
     * @param content the {@link com.appspot.example_88523.helloworld.model.HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.appspot.example_88523.helloworld.model.HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends HelloworldRequest<com.appspot.example_88523.helloworld.model.HelloGreeting> {
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.appspot.example_88523.helloworld.model.HelloGreeting content) {
        super(Helloworld.this, "POST", REST_PATH, content, com.appspot.example_88523.helloworld.model.HelloGreeting.class);
